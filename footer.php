    ...
    <div class="container-xl">
        <div class="footer-inner">
            <div class="row d-flex align-items-center gy-4">
                <!-- copyright text -->
                <div class="col-md-4">
                    <span class="copyright">© 2021 Aday Template - Bom Ajans</span>
                </div>
                <!-- social icons -->
                ...
                <!-- go to top button -->
                <div class="col-md-4">
                    <a href="#" id="return-to-top" class="float-md-end"><i class="icon-arrow-up"></i>Top</a>
                </div>
            </div>
        </div>
    </div>
...
<script src="<?=get_template_directory_uri();?>/js/jquery.sticky-sidebar.min.js"></script>
